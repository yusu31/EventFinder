...
> **Roam**（英語で「自由に歩き回る・旅する」）＋ **i**（"my" の意）

「私だけの旅」をそのままアプリ名にしました。  
観光ガイドや旅行サイトが示すルートを辿るのではなく、自分のペースで福島を歩き、  
気になるイベントに飛び込み、偶然見つけたスポットを写真に残す――そんな**個人の体験**を積み重ねていくアプリです。  
「ろーみー」という音の柔らかさにも、気負わず福島をぶらぶら楽しんでほしいという思いを込めています。
...
### マップ制覇（訪問を記録しながら福島 59 市町村を制覇しよう）

> 市町村をクリックすると「訪問を記録」カードが開きます。写真・訪問日・誰と行ったか・思い出メモを登録するごとに地図が埋まっていき、訪れた場所の思い出を蓄積できます。全市町村を制覇するとコレクションアイテムが解放されます。
